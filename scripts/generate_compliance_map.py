#!/usr/bin/env python3
"""
Generate a compliance framework mapping dataset for VulnScan.

Maps vulnerability categories and severities to compliance framework controls:
- NIST SP 800-53
- PCI DSS v4.0
- CIS Controls v8
- ISO/IEC 27001:2022
...
# Compliance control mappings by vulnerability category
COMPLIANCE_MAP = [
    ...
    {
        "plugin_category": "cve",
        "plugin_ids": ["cve.match.nvd_cpe", "cve.match.cms", "cve.match.packages"],
        "finding_pattern": "cve",
        "severity_map": {
            "critical": {
    ...
    # --- CISA KEV ---
    {
        "plugin_category": "priority",
        "plugin_ids": ["priority.cisa_kev"],
        "finding_pattern": "kev",
        "frameworks": {
...
CONTROL_DESCRIPTIONS = {
    ...
    "pci_dss_v4": {
        "1.2.1": "Network security controls configured and maintained",
        "1.3.1": "Inbound traffic restricted to necessary access",
        ...
        "12.10.5": "Alert monitoring and response procedures",
    },
    "cis_v8": {
...
def main():
    ...
    ap.add_argument("--out", required=True, help="Output compliance_map.json")
    args = ap.parse_args()
